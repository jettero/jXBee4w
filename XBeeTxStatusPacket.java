...
public class XBeeTxStatusPacket extends XBeePacket {
    public static final int TXS_HEADER_LEN    = API_MESSAGE_TYPE_LEN + FRAME_ID;
    public static final int TXS_FRAME_ID_BYTE = FRAME_HEADER_LEN + API_MESSAGE_TYPE_LEN;
    public static final int TXS_STATUS_BYTE   = TX_FRAMEID_BYTE + FRAME_ID_LEN;
    ...
    public boolean statusCCAERR() { return packet[TXS_STATUS_BYTE] == TXS_STATUS_CCAERR;  }
